...
{ 
    public partial class MainForm : Form
    {
        ...
        private void grayToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ImageClass.Binary(img);
            int[,] Etiquetas = ImageClass.ImageSegmentation(img);
            ...
            using (StreamWriter file = new StreamWriter("C:\\Users\\fenrir\\Desktop\\image\\CG OpenCV Base (1)\\teste.csv"))
            {
            ...
            recorte = new System.Drawing.Rectangle(width, height, widthCarta, heightCarta);
            ImageViewer.Image = img.Bitmap;
            ImageViewer.Refresh(); // refresh image on the screen
